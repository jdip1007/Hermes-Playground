...
Australian real estate agent who holds dual professional qualifications as both a **certified accountant** and **lawyer** — one of the few in Australia with this combination [1]. Runs a Cantonese-language YouTube channel focused on Australian property investment, personal finance, and expat life [1].
...
Cantonese-language content targeting Chinese-speaking audiences interested in Australian property investment [1]. Covers:

- Australian real estate market analysis with data-driven approaches (CoreLogic, Domain, ABS)
- Investment-grade asset selection criteria
...
Data-backed approach citing RBA, IMF, OECD, ASIC, ABS, CoreLogic, and Domain research [1]. Combines practical real estate experience with accounting/legal expertise — rare combination that allows her to address tax, legal, and investment dimensions simultaneously [1]. Content is opinion-based (disclaimed as such) but grounded in cited institutional data [1].
