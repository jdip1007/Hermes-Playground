...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Changelogs-34-blueviolet?style=for-the-badge" alt="Changelogs" height="28">
  <img src="https://img.shields.io/badge/Version-v0.15.1_(b9646276)-purple?style=for-the-badge" alt="Version" height="28">
...
### 更新日志（34 个，最新优先 — 完整列表见 [index.md](index.md)）
...
- **更新日志**: 34 个
- **源码覆盖**: 关键模块逐行验证
- **跟踪版本**: v0.15.1（hermes-agent/main HEAD `b9646276f`，2026-06-01 09:57 -0700）
- **最后更新**: 2026-06-01
